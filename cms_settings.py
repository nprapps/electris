...
STATES_HEADER = ['id', 'stateface', 'name', 'abbr', 'electoral_votes', 'polls_close', 'prediction', 'ap_call', 'accept_ap_call', 'npr_call', 'total_precincts', 'precincts_reporting', 'rep_vote_count', 'dem_vote_count']
